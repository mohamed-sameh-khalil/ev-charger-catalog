export const translations = {
  en: {
    ...
    expert_success_title: "We've Received Your Request",
    expert_success_body: 'Thank you for getting in touch. One of our experts will contact you shortly to assist with your enquiry.',
    quote_success_title: 'Quote Request Received',
    quote_success_body: 'Thank you for your interest. One of our team members will review your request and reach out to you shortly with a tailored quote.',
    form_close: 'Close',
...
<p>If your car's connector does not match the charger, you may be able to use an adapter. Always check before you travel to an unfamiliar station.</p>`,
  ...
  ar: {
    ...
    expert_success_title: 'استلمنا طلبك',
    expert_success_body: 'شكراً لتواصلك معنا. سيتواصل معك أحد خبرائنا قريباً للمساعدة في استفسارك.',
    quote_success_title: 'تم استلام طلب عرض السعر',
    quote_success_body: 'شكراً لاهتمامك. سيراجع أحد أعضاء فريقنا طلبك ويتواصل معك قريباً بعرض سعر مخصص.',
    form_close: 'إغلاق',
